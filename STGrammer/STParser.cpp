...
bool STParser::sempred(RuleContext *context, size_t ruleIndex, size_t predicateIndex) {
  switch (ruleIndex) {
    case 11: return orExprSempred(antlrcpp::downCast<OrExprContext *>(context), predicateIndex);
    case 12: return andExprSempred(antlrcpp::downCast<AndExprContext *>(context), predicateIndex);
    case 13: return equalExprSempred(antlrcpp::downCast<EqualExprContext *>(context), predicateIndex);
    case 14: return relationExprSempred(antlrcpp::downCast<RelationExprContext *>(context), predicateIndex);
    case 15: return addExprSempred(antlrcpp::downCast<AddExprContext *>(context), predicateIndex);
    case 16: return multipliExprSempred(antlrcpp::downCast<MultipliExprContext *>(context), predicateIndex);
    case 28: return identSempred(antlrcpp::downCast<IdentContext *>(context), predicateIndex);
