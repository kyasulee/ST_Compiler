...
public:
  enum {
    T__0 = 1, T__1 = 2, T__2 = 3, T__3 = 4, T__4 = 5, NUMBER = 6, IDENT = 7, 
    VAR = 8, IF = 9, THEN = 10, ELSE = 11, END_IF = 12, FOR = 13, TO = 14, 
    DO = 15, END_FOR = 16, ASSIGN = 17, ADD = 18, MINUS = 19, MUL = 20, 
    DIV = 21, SEMI = 22, COLON = 23, LPAREN = 24, RPAREN = 25, WS = 26, 
    ID = 27
  };

  enum {
    RuleProgram = 0, RuleStatement = 1, RuleVarDeclaration = 2, RuleAssignStmt = 3, 
    RuleExpr = 4, RuleAddExpr = 5, RuleMulExpr = 6, RulePrimary = 7, RuleIfStmt = 8, 
    RuleForStmt = 9, RuleType = 10
  };
